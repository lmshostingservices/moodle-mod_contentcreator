...
class mod_contentcreator_generator extends testing_module_generator {
    ...
    /**
     * Create a "Before you start" checklist record for a user.
     *
     * @param stdClass $user The user.
     * @param stdClass $cm The course module.
     * @param string $topicid The manifest topic id the checklist belongs to.
     * @param int $complete Whether the checklist is complete.
     * @return int The record ID.
     */
    public function create_checklist($user, $cm, $topicid = 'topic1', $complete = 1) {
        global $DB;
        ...
        return $DB->insert_record('contentcreator_checklist', $record);
    }
}
