...
define('mod_contentcreator/player5', [
    'jquery',
    'core/str',
    'core/ajax',
    'core/notification',
...
], function($, Str, Ajax, Notification, UI_LABELS, CcState, CcIcons, CcActivities, CcCardSlots, CcVoiceover, CcLangSwitcher) {
    'use strict';
    ...
    /**
     * Sanitize document content - remove unwanted Unicode characters (v6.5.64)
     * Removes checkbox/square Unicode characters that AI might have generated:
     * \u2610 \u2611 OK OK \u25a1 \u25a0 \u25a2 \u25a3 \u25fb \u25fc \u2b1c \u2b1b \u274f \u2750 \u2751 \u2752
     * These characters should NOT appear in table item text columns
     */
    function sanitizeDocumentContent(html) {
        if (!html) return html;
        
        // Unicode checkbox/square characters to remove from item text
        // These are commonly generated by AI but shouldn't appear in formatted documents
        var checkboxChars = /[\u2610\u2611OKOK\u25a1\u25a0\u25a2\u25a3\u25fb\u25fc\u2b1c\u2b1b\u274f\u2750\u2751\u2752]\s*/g;
        
        // Also remove any leading whitespace after checkbox removal
        var cleaned = html.replace(checkboxChars, '');
    ...
    /**
     * Document Registry for workplace document popup links (v6.5.3)
     * Inline registry for detection - full registry loaded dynamically
     */
    var DOCUMENT_ALIASES = {
        // Safety & Risk
        'swms': { id: 'swms', displayName: 'Safe Work Method Statement (SWMS)' },
        'safe work method statement': { id: 'swms', displayName: 'Safe Work Method Statement (SWMS)' },
        'jsa': { id: 'jsa', displayName: 'Job Safety Analysis (JSA)' },
        'jha': { id: 'jsa', displayName: 'Job Safety Analysis (JSA)' },
        'job safety analysis': { id: 'jsa', displayName: 'Job Safety Analysis (JSA)' },
        'job hazard analysis': { id: 'jsa', displayName: 'Job Safety Analysis (JSA)' },
        'risk assessment': { id: 'risk_assessment', displayName: 'Risk Assessment' },
        'hazard report': { id: 'hazard_report', displayName: 'Hazard Report' },
        'incident report': { id: 'incident_report', displayName: 'Incident / Injury Report' },
        'injury report': { id: 'incident_report', displayName: 'Incident / Injury Report' },
        'accident report': { id: 'incident_report', displayName: 'Incident / Injury Report' },
        'near miss report': { id: 'near_miss_report', displayName: 'Near Miss Report' },
        'near miss': { id: 'near_miss_report', displayName: 'Near Miss Report' },
        'permit to work': { id: 'permit_to_work', displayName: 'Permit to Work' },
        'ptw': { id: 'permit_to_work', displayName: 'Permit to Work' },
        'pre-start checklist': { id: 'prestart_checklist', displayName: 'Pre-Start Safety Checklist' },
        'prestart checklist': { id: 'prestart_checklist', displayName: 'Pre-Start Safety Checklist' },
        'pre-start': { id: 'prestart_checklist', displayName: 'Pre-Start Safety Checklist' },
        'emergency plan': { id: 'emergency_plan', displayName: 'Emergency Response Plan' },
        'emergency response': { id: 'emergency_plan', displayName: 'Emergency Response Plan' },
        'ppe checklist': { id: 'ppe_checklist', displayName: 'PPE Checklist' },
        'ppe register': { id: 'ppe_checklist', displayName: 'PPE Checklist' },
        // Operations
        'sop': { id: 'sop', displayName: 'Standard Operating Procedure (SOP)' },
        'standard operating procedure': { id: 'sop', displayName: 'Standard Operating Procedure (SOP)' },
        'work instruction': { id: 'work_instruction', displayName: 'Work Instruction' },
        'job card': { id: 'job_card', displayName: 'Job Card / Job Sheet' },
        'job sheet': { id: 'job_card', displayName: 'Job Card / Job Sheet' },
        'maintenance log': { id: 'maintenance_log', displayName: 'Maintenance Log' },
        'service log': { id: 'maintenance_log', displayName: 'Maintenance Log' },
        'quality checklist': { id: 'quality_checklist', displayName: 'Quality Checklist' },
        'shift handover': { id: 'shift_handover', displayName: 'Shift Handover Log' },
        // People & Conduct
        'code of conduct': { id: 'code_of_conduct', displayName: 'Code of Conduct' },
        'equal opportunity': { id: 'equal_opportunity_policy', displayName: 'Equal Opportunity Policy' },
        'eeo policy': { id: 'equal_opportunity_policy', displayName: 'Equal Opportunity Policy' },
        'bullying policy': { id: 'bullying_harassment_policy', displayName: 'Bullying & Harassment Policy' },
        'harassment policy': { id: 'bullying_harassment_policy', displayName: 'Bullying & Harassment Policy' },
        'conflict of interest': { id: 'conflict_of_interest', displayName: 'Conflict of Interest Declaration' },
        'performance review': { id: 'performance_review', displayName: 'Performance Review Form' },
        // Training
        'training record': { id: 'training_record', displayName: 'Training Record' },
        'competency checklist': { id: 'competency_checklist', displayName: 'Competency Checklist' },
        'skills checklist': { id: 'competency_checklist', displayName: 'Competency Checklist' },
        'induction checklist': { id: 'induction_checklist', displayName: 'Induction Checklist' },
        'onboarding checklist': { id: 'induction_checklist', displayName: 'Induction Checklist' },
        // Reporting
        'customer complaint': { id: 'customer_complaint', displayName: 'Customer Complaint Form' },
        'complaint form': { id: 'customer_complaint', displayName: 'Customer Complaint Form' },
        'non-conformance': { id: 'non_conformance', displayName: 'Non-Conformance Report' },
        'ncr': { id: 'non_conformance', displayName: 'Non-Conformance Report' },
        'corrective action': { id: 'corrective_action', displayName: 'Corrective Action Register' },
        'capa': { id: 'corrective_action', displayName: 'Corrective Action Register' },
        // Governance
        'whs policy': { id: 'whs_policy', displayName: 'WHS Policy' },
        'ohs policy': { id: 'whs_policy', displayName: 'WHS Policy' },
        'privacy policy': { id: 'privacy_policy', displayName: 'Privacy Policy' },
        'data handling': { id: 'data_handling', displayName: 'Data Handling Procedure' },
        // Customer
        'client intake': { id: 'client_intake', displayName: 'Client Intake / Consent Form' },
        'consent form': { id: 'client_intake', displayName: 'Client Intake / Consent Form' },
        'customer feedback': { id: 'customer_feedback', displayName: 'Customer Feedback Form' }
    };

    // Build regex pattern for document detection (sorted by length descending)
    var docAliasPatternStr = Object.keys(DOCUMENT_ALIASES)
        .sort(function(a, b) { return b.length - a.length; })
        .map(function(a) { return a.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'); })
        .join('|');
    var DOCUMENT_ALIAS_PATTERN = new RegExp('\\b(' + docAliasPatternStr + ')\\b', 'gi');
    ...
    var Player = function(config) {
        ...
        // v6.7.6: API URL and credentials for image generation and community gallery
        this.apiUrl = 'https://lms-labs.com';
        ...
        if ((_voTotal - _voWithUrl - _voSentinel) > 0) {
            console.warn('[VOICEOVER v' + CC_VERSION + '] ' + (_voTotal - _voWithUrl - _voSentinel) + '/' + _voTotal + ' sections MISSING pre-generated voiceover. Students will experience delays.');
        }
        ...
        // ─── CC-ML-DEBUG v13.3 ───────────────────────────────────────────────
        // Comprehensive multi-language diagnostic. Filter console by [CC-ML] to see only these.
        var self = this;
        var _mlEntries = (config.manifest.multiLanguage || []);
        var _mlInitSummary = _mlEntries.map(function(e) {
            var _urlC = 0, _sentC = 0, _missC = 0;
            (e.topics || []).forEach(function(t) {
                (t.sections || []).forEach(function(s) {
                    if (s.slideType === 'activity') { return; }
                    if (typeof s.voiceoverUrl === 'string' && s.voiceoverUrl.startsWith('http')) { _urlC++; }
                    else if (s.voiceoverUrl === 'pregenerated') { _sentC++; }
                    else { _missC++; }
                });
            });
            return { code: e.code, topics: (e.topics || []).length,
                     http: _urlC, pregenerated: _sentC, missing: _missC };
        });
        console.log('%c[CC-ML INIT v' + CC_VERSION + ']',
            'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;font-weight:bold;',
            'voice=' + this.voiceName, '| lang=' + this.voiceLanguage,
            '| multiLanguage entries=' + _mlEntries.length,
            _mlInitSummary.length ? _mlInitSummary : '(none)',
            '| voiceoversComplete=' + config.manifest.voiceoversComplete);
        if (_mlInitSummary.some(function(e) { return e.missing > 0; })) {
            console.warn('%c[CC-ML WARN MISSING URLs]',
                'background:#d97706;color:#fff;padding:2px 6px;border-radius:3px;',
                'Some additional-language sections have no voiceover URL — students will hear silence for those sections.');
        }
        // Expose ccMLDump() in browser console for live state inspection
        window.ccMLDump = function() {
            console.group('%c CC-ML LIVE STATE DUMP', 'background:#7c3aed;color:#fff;padding:4px 8px;border-radius:3px;font-size:13px;font-weight:bold;');
            console.log('activeLang :', self.activeLang || '(primary)');
            console.log('voiceLanguage:', self.voiceLanguage, '| voiceName:', self.voiceName);
            console.log('voiceoverEnabled:', self.voiceoverEnabled, '| voiceoversComplete:', self.manifest.voiceoversComplete);
            console.log('isTeacher:', self.isTeacher, '| canEdit:', self.canEdit, '| editMode:', self.editMode);
            console.log('voiceoverCache keys:', Object.keys(self.voiceoverCache || {}).length,
                '| voiceoverLoading keys:', Object.keys(self.voiceoverLoading || {}).length);
            var _allML = self.manifest.multiLanguage || [];
            console.log('multiLanguage entries in live manifest:', _allML.length);
            _allML.forEach(function(e) {
                var _sects = [];
                (e.topics || []).forEach(function(t) { (t.sections || []).forEach(function(s) { if (s.slideType !== 'activity') { _sects.push(s); } }); });
                console.group('  [' + e.code + '] ' + (e.label || ''));
                console.log('  topics:', (e.topics || []).length, '| non-activity sections:', _sects.length);
                _sects.forEach(function(s) {
                    var _u = s.voiceoverUrl;
                    var _tag = !_u ? 'MISSING' : (_u === 'pregenerated' ? 'PREGENERATED' : (_u.startsWith('http') ? 'HTTPS-URL' : 'DATA-URL'));
                    console.log('    sec', s.id, '|', _tag, '| status:', s.voiceoverStatus || 'none', '| cached:', !!self.voiceoverCache[s.id]);
                });
                console.groupEnd();
            });
            var _primSects = [];
            (self._primaryTopics || self.manifest.topics || []).forEach(function(t) { (t.sections || []).forEach(function(s) { if (s.slideType !== 'activity') { _primSects.push(s); } }); });
            console.group('  [PRIMARY ' + self.voiceLanguage + ']');
            console.log('  non-activity sections:', _primSects.length);
            _primSects.forEach(function(s) {
                var _u = s.voiceoverUrl;
                var _tag = !_u ? 'MISSING' : (_u === 'pregenerated' ? 'PREGENERATED' : (_u.startsWith('http') ? 'HTTPS-URL' : 'DATA-URL'));
                console.log('    sec', s.id, '|', _tag, '| status:', s.voiceoverStatus || 'none', '| cached:', !!self.voiceoverCache[s.id]);
            });
        ...
        // Plain-text fallback  -  no console.group() needed, fully copyable
        window.ccMLText = function() {
            var lines = [];
            lines.push('=== CC-ML TEXT DUMP v' + CC_VERSION + ' ===');
            lines.push('activeLang: ' + (self.activeLang || '(primary)'));
            lines.push('voiceLanguage: ' + self.voiceLanguage + ' | voiceName: ' + self.voiceName);
            lines.push('voiceoverEnabled: ' + self.voiceoverEnabled + ' | voiceoversComplete: ' + self.manifest.voiceoversComplete);
            lines.push('isTeacher: ' + self.isTeacher + ' | canEdit: ' + self.canEdit + ' | editMode: ' + self.editMode);
            lines.push('voiceoverCache keys: ' + Object.keys(self.voiceoverCache || {}).length);
            var _allML = self.manifest.multiLanguage || [];
            lines.push('multiLanguage entries: ' + _allML.length);
            _allML.forEach(function(e) {
                var _sects = [];
                (e.topics || []).forEach(function(t) { (t.sections || []).forEach(function(s) { if (s.slideType !== 'activity') { _sects.push(s); } }); });
                lines.push('  [' + e.code + '] label=' + (e.label || '') + ' | topics=' + (e.topics || []).length + ' | sections=' + _sects.length);
                _sects.forEach(function(s) {
                    var _u = s.voiceoverUrl;
                    var _tag = !_u ? 'MISSING' : (_u === 'pregenerated' ? 'PREGENERATED' : (_u.startsWith('http') ? 'HTTPS-URL' : 'DATA-URL'));
                    lines.push('    sec ' + s.id + ' | ' + _tag + ' | status=' + (s.voiceoverStatus || 'none') + ' | cached=' + !!self.voiceoverCache[s.id]);
                });
            });
            var _primSects = [];
            (self._primaryTopics || self.manifest.topics || []).forEach(function(t) { (t.sections || []).forEach(function(s) { if (s.slideType !== 'activity') { _primSects.push(s); } }); });
            lines.push('  [PRIMARY ' + self.voiceLanguage + '] sections=' + _primSects.length);
            _primSects.forEach(function(s) {
                var _u = s.voiceoverUrl;
                var _tag = !_u ? 'MISSING' : (_u === 'pregenerated' ? 'PREGENERATED' : (_u.startsWith('http') ? 'HTTPS-URL' : 'DATA-URL'));
                lines.push('    sec ' + s.id + ' | ' + _tag + ' | status=' + (s.voiceoverStatus || 'none') + ' | cached=' + !!self.voiceoverCache[s.id]);
        ...
        console.log('%c[CC-ML]', 'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
            '▶ Type  ccMLDump()  in this console for a full live state dump of all language/voiceover data.',
            '| For a plain copyable text version type:  ccMLText()');
        // ─── END CC-ML-DEBUG ─────────────────────────────────────────────────
    ...
    Player.prototype = {
            ...
            if ((cachedState && cachedState.ready) || hasExistingContent) {
                ...
                if (cachedState) {
                    ...
                    if (cachedState.activeLang) {
                        ...
                        console.log('%c[CC-ML RESTORE]',
                            'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
                            'Session had activeLang=' + cachedState.activeLang,
                            '| restored:', _foundRestore ? 'YES — topics swapped' : 'NO — code not found in multiLanguage array (entries: ' + _mlArr.length + ')');
                    }
                }
        ...
        loadSessionState: function() {
            try {
                ...
                if (stored) {
                    ...
                    var age = state.timestamp ? Math.round((now - state.timestamp) / 1000) : -1;
        ...
        markChecklistComplete: function() {
            ...
            if (typeof M !== 'undefined' && M.cfg && M.cfg.wwwroot) {
                try {
                    ...
                    checklistData.append('sesskey', M.cfg.sesskey);
                    ...
                    fetch(M.cfg.wwwroot + '/mod/contentcreator/ajax.php', {
                        method: 'POST',
                        body: checklistData
                    }).catch(function() {
                        // Silently fail  -  localStorage backup already written above
                    });
                } catch (e) {
                }
            }
        ...
        loadMoodleProgress: function() {
            ...
            var ajaxUrl = M.cfg.wwwroot + '/mod/contentcreator/ajax.php';
        ...
        preloadVoiceovers: function(onComplete) {
            var _preloadStartTime = Date.now();            // v6.5.11: Skip preloading if voiceover is disabled
            ...
            // CC-ML-DEBUG: log preload entry state
            console.log('%c[CC-ML PRELOAD START]',
                'background:#0369a1;color:#fff;padding:2px 6px;border-radius:3px;',
                'activeLang=' + (self.activeLang || '(primary)'),
                '| voiceLanguage=' + self.voiceLanguage,
                '| voiceName=' + self.voiceName,
                '| sections found=' + allSections.length,
                '| voiceoverEnabled=' + self.voiceoverEnabled,
                '| voiceoversComplete=' + self.manifest.voiceoversComplete);
            allSections.forEach(function(s) {
                var _u = s.voiceoverUrl;
                var _tag = !_u ? 'MISSING' : (_u === 'pregenerated' ? 'sentinel' : (_u.startsWith('http') ? 'https' : 'data'));
                console.log('%c[CC-ML SEC]', 'background:#475569;color:#fff;padding:1px 4px;border-radius:2px;',
                    '  sec=' + s.id, '| url=' + _tag, '| status=' + (s.voiceoverStatus || 'none'),
                    '| cached=' + !!self.voiceoverCache[s.id]);
            });
            ...
            function checkComplete() {
                ...
                if (index >= allSections.length && activeRequests === 0) {
                    ...
                    var _preloadDuration = ((Date.now() - _preloadStartTime) / 1000).toFixed(1);
                    var _cachedCount = Object.keys(self.voiceoverCache).length;
                    // CC-ML-DEBUG
                    var _failList = allSections.filter(function(s) { return !CcVoiceover.isSectionVoiceoverComplete(s); });
                    console.log('%c[CC-ML PRELOAD DONE]',
                        'background:#0369a1;color:#fff;padding:2px 6px;border-radius:3px;',
                        'activeLang=' + (self.activeLang || '(primary)'),
                        '| duration=' + _preloadDuration + 's',
                        '| cached=' + _cachedCount,
                        '| incomplete sections=' + _failList.length + '/' + allSections.length);
                    if (_failList.length) {
                        _failList.forEach(function(s) {
                            console.warn('%c[CC-ML INCOMPLETE]',
                                'background:#dc2626;color:#fff;padding:1px 4px;border-radius:2px;',
                                '  sec=' + s.id, '| url=' + (s.voiceoverUrl || 'NONE'), '| status=' + (s.voiceoverStatus || 'none'));
                        });
                    }
                    ...
                    if (self.editMode || self.canEdit || self.isTeacher) {
                        ...
                        if (_missingSections.length > 0) {
                            console.warn('[CC v' + CC_VERSION + '] POST-PRELOAD SWEEP: ' + _missingSections.length + ' section(s) still missing audio  -  retrying in 10s');
                        ...
                        if (_isComplete) {
                            ...
                            console.warn('[CC v' + CC_VERSION + '] INCOMPLETE VOICEOVERS  -  ' + _failCount + ' section(s) not complete. Uploads still in-flight — save deferred to persistVoiceoverToFileStore callbacks.');
                        }
                    }
            ...
            function preloadOne(section) {
                ...
                if (self.voiceoverCache[section.id] || (self.voiceoverLoading[section.id] && !_isScheduledRetry)) {
                    var _reason = self.voiceoverCache[section.id] ? 'CACHED' : 'LOADING';                    self.voiceoverPreloadStatus.loaded++;
                ...
                if (!_hasHttpsUrl || _teacherNeedsRegen) {
                    ...
                    if (_teacherNeedsRegen) {
                        console.warn('[VOICEOVER v' + CC_VERSION + '] PRELOAD FORCE REGEN section ' + section.id + '  -  has URL but voiceoverStatus=' + section.voiceoverStatus + ' (not complete). Saving fallback URL for instant play.');
                ...
                if (section.voiceoverUrl) {
                    ...
                    if ((preIsStale || preNoFingerprint) && preCanRegen) {
                        console.warn('[VOICEOVER v' + CC_VERSION + '] PRELOAD STALE section ' + section.id + ' | schema: ' + preStoredSchema + '/' + VOICEOVER_SCHEMA_VERSION + ' | stored: ' + preStoredWords + ' | current: ' + preCurrentWords + ' | hashStale: ' + preIsHashStale + ' | noHash: ' + preNoHash + ' | regenerating (editMode=' + self.editMode + ' canEdit=' + self.canEdit + ')');
                ...
                if (!self.editMode && !self.canEdit && !self.isTeacher) {
                    ...
                    console.warn('%c[CC-ML STUDENT-SKIP]',
                        'background:#dc2626;color:#fff;padding:1px 4px;border-radius:2px;',
                        'Student gate: section ' + section.id + ' has no URL and student cannot generate.',
                        '| voiceoverUrl=' + (section.voiceoverUrl || 'NONE'),
                        '| activeLang=' + (self.activeLang || '(primary)'),
                        '→ This section will play SILENCE. Teacher must re-generate voiceovers.');
                ...
                // CC-ML-DEBUG
                console.log('%c[CC-ML TTS-REQ]',
                    'background:#0369a1;color:#fff;padding:2px 6px;border-radius:3px;',
                    'section=' + section.id,
                    '| sending language=' + (self.activeLang || self.voiceLanguage),
                    '| voice=' + self.voiceName,
                    '| activeLang=' + (self.activeLang || 'null') + ' voiceLanguage=' + self.voiceLanguage);
                ...
                .then(function(data) {
                    var _apiDuration = ((Date.now() - _apiStartTime) / 1000).toFixed(1);
                    ...
                    if (data.pending) {
                        ...
                        console.warn('[CC v' + CC_VERSION + '] TTS PENDING section ' + section.id + '  -  server busy, waiting 10s (pending attempt ' + _pendingCount + ')');
                        ...
                        if (_pendingCount < 25) {
                            ...
                            console.error('[CC v' + CC_VERSION + '] TTS PENDING exhausted for section ' + section.id + '  -  too many concurrent waits');
                            self.voiceoverPreloadStatus.loaded++;
                            self.updatePreloadingProgress();
                            activeRequests--;
                            startNext();
                    ...
                    if (data.success && data.audioContent) {
                        // CC-ML-DEBUG
                        console.log('%c[CC-ML TTS-OK]',
                            'background:#16a34a;color:#fff;padding:2px 6px;border-radius:3px;',
                            'section=' + section.id,
                            '| activeLang=' + (self.activeLang || '(primary)'),
                            '| audioType=' + data.audioType,
                            '| audioContent bytes~=' + Math.round(data.audioContent.length * 0.75));
                        ...
                        console.error('[CC v' + CC_VERSION + '] ' + _softErr + '  -  routing to retry mechanism');
                ...
                .catch(function(error) {
                    ...
                    if (isAborted && section._preloadAbortedByUser) {
                        ...
                        delete section._preloadAbortCtrl;
                        console.warn('[CC v' + CC_VERSION + '] Preload for section ' + section.id + ' cancelled by user retry  -  old chain exiting cleanly');
                        activeRequests--;
                        startNext();
                        return;
                    }
                    delete section._preloadAbortCtrl;
                    console.error('[CC v' + CC_VERSION + '] Preload voiceover failed section ' + section.id + ' - ' + (isAborted ? 'TIMEOUT 200s' : errorMsg) + ' (attempt ' + (_preRetry + 1) + ')');
                    if (/429|quota|rate.limit|resource.exhausted/i.test(errorMsg)) {
                        console.error('[CC v' + CC_VERSION + '] QUOTA/RATE LIMIT hit during preload - Google Chirp 3 HD');
                    }
                    ...
                    if (self._voiceoverChainGen !== _myChainGen) {
                        ...
                        if (_supRetries < 3 &&
                            ...
                            console.warn('[CC v' + CC_VERSION + '] FIX-CC-ORPHANED-SECTION: section ' + section.id + ' freed after chain supersede  -  scheduling fresh preload in 2s (rescue ' + (_supRetries + 1) + '/3)');
                            setTimeout(function() { self.preloadVoiceovers(); }, 2000);
                        }
                        console.warn('[CC v' + CC_VERSION + '] Preload chain for section ' + section.id + ' superseded (gen ' + _myChainGen + '  ->  ' + self._voiceoverChainGen + ')  -  exiting cleanly, new chain owns it');
                        activeRequests--;
                        startNext();
                        return;
                    }
                    ...
                    if (_preRetry < MAX_PRELOAD_RETRIES) {
                        ...
                        console.warn('[CC v' + CC_VERSION + '] PRELOAD RETRY ' + (_preRetry + 1) + '/' + MAX_PRELOAD_RETRIES + ' section ' + section.id + ' in ' + (_retryDelay / 1000) + 's (voiceoverLoading kept true during delay)');
                        ...
                        setTimeout(function() {
                            ...
                            if (self._voiceoverChainGen !== _myChainGen) {
                                delete section._preloadScheduledRetry;
                                delete self.voiceoverLoading[section.id];
                                console.warn('[CC v' + CC_VERSION + '] Retry timeout for section ' + section.id + ' cancelled  -  chain superseded (gen ' + _myChainGen + '  ->  ' + self._voiceoverChainGen + ')');
                                return;
                            }
                            preloadOne(section);
                        }, _retryDelay);
                        ...
                        section.voiceoverStatus = 'failed';
                        console.error('[CC v' + CC_VERSION + '] PRELOAD EXHAUSTED section ' + section.id + ' after ' + MAX_PRELOAD_RETRIES + ' retries  -  voiceoverStatus=failed (session only; stripped from DB save by stripAudio so next reload retries visibly)');
                        self.voiceoverPreloadStatus.loaded++;
                        self.updatePreloadingProgress();
                        activeRequests--;
                        startNext();
        ...
        priorityPreloadCurrentSlide: function() {
            ...
            .then(function(data) {
                ...
                if (data.success && data.audioContent) {
                    ...
                    console.warn('[VOICEOVER v' + CC_VERSION + '] PRIORITY PRELOAD FAILED section ' + currentSection.id + ' | ' + (data.error || 'no audio'));
                }
            })
            .catch(function(error) {
                delete self.voiceoverLoading[currentSection.id];
                console.error('[VOICEOVER v' + CC_VERSION + '] PRIORITY PRELOAD ERROR section ' + currentSection.id + ' | ' + error.message);
            });
        },
        /**
        ...
        renderVoiceoverWaiting: function() {
            ...
            this.container.find('.cc5-vo-wait-retry-btn').off('click').on('click', function() {
                ...
                console.warn('[CC v' + CC_VERSION + '] RETRY BUTTON CLICKED  -  aborting any in-flight fetches and re-queuing all incomplete sections');
        ...
        setActiveLang: function(code) {
            ...
            var _mlArrDbg = this.manifest.multiLanguage || [];
            console.log('%c[CC-ML SET-LANG]',
                'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
                'setActiveLang("' + code + '")',
                '| current activeLang=' + (this.activeLang || '(primary)'),
                '| multiLanguage entries=' + _mlArrDbg.length,
                '| available codes: [' + _mlArrDbg.map(function(e) { return e.code + '(' + (e.topics || []).length + 't)'; }).join(', ') + ']');
            ...
            if (!code) {
                ...
                // CC-ML-DEBUG: log mlEntry lookup result
                if (mlEntry) {
                    console.log('%c[CC-ML FOUND]',
                        'background:#16a34a;color:#fff;padding:2px 6px;border-radius:3px;',
                        'mlEntry found for code=' + code,
                        '| topics=' + (mlEntry.topics || []).length,
                        '| voiceSettings=' + JSON.stringify(mlEntry.voiceSettings || {}));
                    if (!mlEntry.topics || !mlEntry.topics.length) {
                        console.error('%c[CC-ML EMPTY TOPICS]',
                            'background:#dc2626;color:#fff;padding:2px 6px;border-radius:3px;',
                            'mlEntry found for ' + code + ' but topics array is EMPTY — swap will NOT happen!');
                    }
                } else {
                    console.error('%c[CC-ML NOT FOUND]',
                        'background:#dc2626;color:#fff;padding:2px 6px;border-radius:3px;',
                        'NO mlEntry found for code="' + code + '"',
                        '| manifest.multiLanguage has ' + mlArr.length + ' entries:',
                        mlArr.map(function(e) { return e.code; }));
                }
                if (mlEntry && mlEntry.topics && mlEntry.topics.length) {
                    ...
                    (function() {
                        ...
                        if (_dbgSect) {
                            var _dbgCard0 = (_dbgSect.cards && _dbgSect.cards.length) ? _dbgSect.cards[0] : null;
                            console.log('%c[CC-ML CONTENT-SAMPLE v13.8]',
                                'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;font-weight:bold;',
                                'lang=' + code,
                                '\n  section.id:', _dbgSect.id,
                                '\n  section.title (first 120):', String(_dbgSect.title || '(empty)').substring(0, 120),
                                '\n  section.voiceoverText (first 150):', String(_dbgSect.voiceoverText || '(none)').substring(0, 150),
                                '\n  card[0].voiceoverText (first 150):', _dbgCard0 ? String(_dbgCard0.voiceoverText || '(none)').substring(0, 150) : '(no cards)',
                                '\n  card[0].title (first 80):', _dbgCard0 ? String(_dbgCard0.title || '(none)').substring(0, 80) : '(no cards)',
                                '\n  ⚠ IF THE ABOVE TEXT IS ENGLISH, the AI generation produced English content for this language — the course needs to be regenerated.');
                        } else {
                            console.warn('%c[CC-ML CONTENT-SAMPLE v13.8]',
                                'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
                                'lang=' + code + ' — could not find any section in mlEntry.topics to sample');
                        }
                    })();
                }
            }
        ...
        renderSlideView: function() {            var self = this;
            ...
            if (!topic) {
                ...
                console.warn('[CC v' + CC_VERSION + '] renderSlideView: topic not found for currentTopicId=' +
            ...
            var theme = getColorTheme(topic.color || 'primary');
            var sectionTheme = getColorTheme(currentSection?.color || topic.color || 'primary');
            ...
            if (currentSection) {
                try {
                    ...
                    console.error('[CC v' + CC_VERSION + '] FIX-CC-RENDER-GUARD: renderSlideContent threw for section=' +
        ...
        renderSlideContent: function(section, topic) {                                  
            ...
            var sectionTheme = getColorTheme(section.color || topic.color || 'primary');
            var sectionIcon = this.getSectionIcon(section);
            ...
            var contextualIcon = getContextualSlideIcon(section.title, section.description);
            ...
            if (!isActivitySlide) {
                ...
                if (section.cards && section.cards.length > 0) {
                    ...
                    _renderCards.forEach(function(c) {
                        if (c.cardType === 'decision-point') _dpCard = c;
        ...
        bulkGenerateImages: function() {
            ...
            function processNext() {
                ...
                self.generateSlideImageBulk(slide.sectionId, function(success) {
                    // v9.79 FIX (A-01): failCount was inside if(success)  -  both counters
                    // incremented on every success. Moved failCount to else branch so the
                    // summary toast reports the actual split of successes vs failures.
                    if (success) {
                        successCount++;
                    } else {
                        failCount++;
        ...
        generateSlideVoiceoverBulk: function(section, topicIndex, sectionIndex, callback) {
            ...
            if (self.voiceoverLoading[section.id]) {
                console.warn('[Bulk Voiceover] Section ' + section.id + ' is already in preload  -  waiting for preload to complete (up to 90s)');
                ...
                var _bulkPollInterval = setInterval(function() {
                    ...
                    if (!self.voiceoverLoading[section.id]) {
                        ...
                        if (_hasAudio) {
                            ...
                            console.warn('[Bulk Voiceover] Section ' + section.id + ' preload lock released but no audio  -  retrying via bulk');
                    ...
                    if (_bulkPollAttempts >= 30) { // 90s timeout
                        clearInterval(_bulkPollInterval);
                        console.warn('[Bulk Voiceover] Section ' + section.id + ' poll timeout  -  preload still in progress after 90s');
            ...
            .catch(function(error) {
                delete self.voiceoverLoading[section.id];
                console.error('[Bulk Voiceover] Error:', error);
                if (callback) callback(false);
            });
        },
            ...
            fetch(ajaxUrl, { method: 'POST', body: formData })
                ...
                .then(function(data) {
                    if (data.success && data.url) {
                        ...
                        console.warn('[VOICEOVER v' + CC_VERSION + '] FILE STORE FAIL section ' + sectionId + ' | ' + (data.error || 'no url returned'));
                    }
                })
                .catch(function(e) {
                    console.warn('[VOICEOVER v' + CC_VERSION + '] FILE STORE ERROR section ' + sectionId + ' | ' + e.message);
                });
        },
        ...
        saveManifestSilent: function() {
            ...
            var sizeKB = Math.round(manifestStr.length / 1024);
            if (manifestStr.length <= CHUNK_THRESHOLD) {
                // Direct save with retry
                function attemptDirectSave(attempt) {                    Ajax.call([{
                        methodname: 'mod_contentcreator_save_manifest',
                        args: { cmid: self.cmid, manifest: manifestStr }
                    }])[0].done(function(response) {
                        if (response && response.success === false) {
                            console.error('[CC SAVE] saveManifestSilent attempt ' + attempt + ' reported failure: ' + response.message);
                            if (attempt < MAX_SAVE_RETRIES) {
                                setTimeout(function() { attemptDirectSave(attempt + 1); }, 1000 * attempt);
                            } else {
                                console.error('[CC SAVE] saveManifestSilent: all ' + MAX_SAVE_RETRIES + ' direct retries exhausted.');
                            }
                        }
                    }).fail(function(error) {
                        console.error('[CC SAVE] saveManifestSilent direct attempt ' + attempt + ' FAILED: ' + (error && (error.message || JSON.stringify(error)) || 'unknown'));
                        if (attempt < MAX_SAVE_RETRIES) {
                            setTimeout(function() { attemptDirectSave(attempt + 1); }, 1000 * attempt);
                        } else {
                            console.error('[CC SAVE] saveManifestSilent: all ' + MAX_SAVE_RETRIES + ' direct retries exhausted.');
            ...
            function attemptChunkedSave(attempt) {
                ...
                function sendChunk(index) {
                    ...
                    Ajax.call([{
                        ...
                        if (response && response.success === false) {
                            console.error('[CC SAVE] Chunk ' + index + ' attempt ' + attempt + ' failed: ' + response.message);
                            if (attempt < MAX_SAVE_RETRIES) {
                                setTimeout(function() { attemptChunkedSave(attempt + 1); }, 1000 * attempt);
                            } else {
                                console.error('[CC SAVE] saveManifestSilent: all ' + MAX_SAVE_RETRIES + ' chunked retries exhausted.');
                            }
                            return;
                        }
                        if (!isLast) {
                        ...
                        console.error('[CC SAVE] Chunk ' + index + ' attempt ' + attempt + ' FAILED: ' + (error && (error.message || JSON.stringify(error)) || 'unknown'));
                        if (attempt < MAX_SAVE_RETRIES) {
                            setTimeout(function() { attemptChunkedSave(attempt + 1); }, 1000 * attempt);
                        } else {
                            console.error('[CC SAVE] saveManifestSilent: all ' + MAX_SAVE_RETRIES + ' chunked retries exhausted.');
        ...
        generateSlideImage: function(sectionId, customPrompt, isRegeneration) {
            ...
            $.ajax({
                url: this.apiUrl + '/api/moodle/content-creator/generate-slide-image',
                method: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(requestData),
                success: function(response) {
                    // v10.62 FIX BUG-CC-IMGGEN: Previous handler was broken in three ways:
                    // (1) When >1 image, it called showImagePickerModal AND applySelectedImage
                    //     simultaneously  -  the first image was immediately applied before the
                    //     user could pick, making the picker useless.
                    // (2) When exactly 1 image, the if-block was skipped so nothing was applied.
                    // (3) throw new Error(...) ran on every successful response, crashing the
                    //     handler. Fix: proper if/else + return on success path.
                    if (response.success && (response.imageUrls || response.imageUrl)) {
                    ...
                    // Failure path (response.success === false)
                    var errorMsg = response.error || 'Failed to generate image';
                    self.render();
                    Notification.addNotification({
                        message: errorMsg,
                        type: 'error'
                ...
                error: function(xhr, textStatus, errorThrown) {
                    var errorMsg = 'Image generation failed';
                    if (xhr.responseJSON && xhr.responseJSON.error) {
                        errorMsg = xhr.responseJSON.error;
                    } else if (xhr.status === 401) {
                        errorMsg = 'Invalid API credentials - check your Site ID and API Key';
                    } else if (xhr.status === 402) {
                        errorMsg = 'Insufficient credits - need 5 credits to generate images';
                    } else if (xhr.status === 0) {
                        errorMsg = 'Network error - could not connect to AI Grader API';
                    } else if (errorThrown) {
                        errorMsg = 'Server error: ' + errorThrown;
                    }
        ...
        /**
         * Browse community gallery via API (v6.6.74)
         */
        browseCommunityGallery: function(sectionId, search, offset) {
            ...
            $.ajax({
                url: this.apiUrl + '/api/community-gallery/browse',
                method: 'GET',
                data: params,
                success: function(response) {
                    ...
                    response.images.forEach(function(img) {
                        ...
                        html += '<img src="' + img.imageUrl + '" alt="Community image">';
                ...
                error: function(xhr) {
                    $('.cc5-community-loading').hide();
                    var $grid = $('.cc5-community-grid');
                    $grid.html('<div class="cc5-community-empty"><p>' + (getLabel('communityLoadFailed') || 'Failed to load community images. Please try again.') + '</p></div>');
                }
            });
        },
        ...
        useCommunityImage: function(sectionId, imageId) {
            ...
            $.ajax({
                url: this.apiUrl + '/api/community-gallery/use',
                method: 'POST',
                contentType: 'application/json',
                data: JSON.stringify({
                    siteId: this.siteId,
            ...
            Ajax.call([{
                ...
                error: function(xhr) {
                    var errorMsg = getLabel('communityImageFailed') || 'Failed to use community image';
                    if (xhr.responseJSON && xhr.responseJSON.error) {
                        errorMsg = xhr.responseJSON.error;
                    }
                    Notification.addNotification({
        ...
        contributeToGallery: function(images, context) {
            ...
            $.ajax({
                url: this.apiUrl + '/api/community-gallery/contribute',
                method: 'POST',
                contentType: 'application/json',
                data: JSON.stringify({
                    siteId: this.siteId,
                ...
                error: function(xhr) {
                    ccWarn('[COMMUNITY-GALLERY] Contribute failed:', xhr.status);
                }
            });
        },

        /**
         * Upload image for slide (v6.6.67)
         */
        uploadSlideImage: function(sectionId, file) {
            ...
            $.ajax({
                url: this.apiUrl + '/api/moodle/content-creator/upload-slide-image',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
            ...
            Ajax.call([{
                            ...
                            showErrorToast(getLabel('manifestSaveFailed') || 'Image was uploaded but settings could not be saved. Please try again.', 'imageUploadManifestSave', error);
                        });
                ...
                error: function(xhr) {
                    var errorMsg = 'Image upload failed';
                    if (xhr.responseJSON && xhr.responseJSON.error) {
                        errorMsg = xhr.responseJSON.error;
                    }
        ...
        bindEvents: function() {
            ...
            this.container.on('click keydown', '.cc5-topic-card', function(e) {
                ...
                console.log('[CC v' + CC_VERSION + '] topic-card click: topicId=' +
            ...
            this.container.on('click', '.cc5-lang-pill', function(e) {
                ...
                console.log('%c[CC-ML CLICK]',
                    'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
                    'lang pill clicked | code="' + code + '" | current activeLang=' + (self.activeLang || '(primary)'));
            ...
            this.container.on('click', '.cc5-regenerate-btn', function(e) {
                ...
                if (failedCount > 0) {
                    var confirmMsg = 'There are ' + failedCount + ' slides with placeholder content. Regenerate only the failed slides? (Successful content will be preserved)';
            ...
            this.container.on('cc5img_error', '.cc5-slide-image-container', function() {
                ...
                console.warn('[CC5] Slide image 404 for section ' + sectionId + ' (server file may have been removed). Recovering UI...');
            ...
            this.container.on('click', '.cc5-image-remove-btn', function(e) {
                if (self.manifest?.topics?.[0]?.sections?.[0]) {
                }
                e.preventDefault();
                e.stopPropagation();
                var sectionId = $(this).data('section-id');
            ...
            $(document).on('click', '.cc5-edit-card-delete', function(e) {
                ...
                if (!confirm('Remove "' + cardLabel + '" from this slide?\n\nThis takes effect when you click Save. Close without saving to cancel.')) return;
            ...
            $(document).on('click', '.cc5-edit-delete-item', function(e) {
                ...
                var itemText = itemToDelete.find('.cc5-edit-item-text').val();
                itemToDelete.remove();
            });
            ...
            this.container.on('input', '.cc5-reflection-input', function() {
                ...
                var total = parseInt($prompts.data('total')) || 0;
        ...
        showEditModal: function(topicId, sectionId) {
            ...
            var grammarFixDeep = function(obj) {
                ...
                for (var key in obj) {
                    if (!obj.hasOwnProperty(key) || skipKeys[key]) continue;
                    ...
                    if (found) {
                        ...
                        if (self.voiceoverEnabled && (regenerateVoiceover || !sec.voiceoverUrl)) {
                            ...
                            if (voText && voText.trim().length > 10) {                                // v12.25: Notify user that voiceover is regenerating in background
                                ...
                                voFormData.append('sesskey', M.cfg.sesskey);
                                ...
                                .then(function(voData) {
                                    ...
                                    if (voData.pending) {
                                        console.warn('[VOICEOVER v' + CC_VERSION + '] AUTO-GEN PENDING section ' + sectionId + '  -  PHP mutex busy (preload in progress); voiceover will be available shortly');
                                        Notification.addNotification({
                                        ...
                                        console.error('[VOICEOVER v' + CC_VERSION + '] AUTO-GEN FAIL section ' + sectionId + ': ' + (voData.error || 'unknown'));
                                ...
                                .catch(function(voErr) {
                                    console.error('[VOICEOVER v' + CC_VERSION + '] AUTO-GEN ERROR section ' + sectionId + ': ' + voErr.message);
        ...
        playVoiceover: function(sectionId) {
            ...
            if (!this.editMode && !this.canEdit && !this.isTeacher && this.manifest.voiceoversComplete !== true) {
                ...
                console.warn('[VOICEOVER v' + CC_VERSION + '] GLOBAL BLOCK section ' + sectionId + '  -  manifest.voiceoversComplete=' + this.manifest.voiceoversComplete + '. Content not ready for students.');
                Notification.addNotification({
            ...
            console.log('%c[CC-ML PLAY ENTRY]',
                'background:#7c3aed;color:#fff;padding:2px 6px;border-radius:3px;',
                'sectionId=' + sectionId,
                '| activeLang=' + (this.activeLang || '(primary)'),
                '| voiceoverUrl=' + (section.voiceoverUrl || '(none)'),
                '| cached=' + !!this.voiceoverCache[sectionId],
                '| editMode=' + this.editMode,
                '| canEdit=' + this.canEdit,
                '| isTeacher=' + this.isTeacher,
                '| voiceoverWordCount=' + (section.voiceoverWordCount || 0),
                '| voiceoverSchema=' + (section.voiceoverSchemaVersion || '(none)'),
                '| voiceoverTextHash=' + (section.voiceoverTextHash ? section.voiceoverTextHash.slice(0,8)+'…' : '(none)'));
            ...
            if (section.voiceoverUrl) {
                ...
                if (isStale || hasNoFingerprint) {
                    console.warn('[VOICEOVER v' + CC_VERSION + '] STALE DETECTED section ' + sectionId + ' | schema: ' + storedSchema + '/' + VOICEOVER_SCHEMA_VERSION + ' | storedWords: ' + storedWordCount + ' | currentWords: ' + currentWordCount + ' | hashStale: ' + isHashStale + ' | noHash: ' + hasNoHash + ' | schemaStale: ' + isSchemaStale + ' | editMode: ' + this.editMode + ' | canEdit: ' + this.canEdit);
                    // CC-ML-DEBUG v13.4: stale/no-fingerprint breakdown
                    console.log('%c[CC-ML PLAY STALE]',
                        'background:#d97706;color:#fff;padding:2px 6px;border-radius:3px;',
                        'section=' + sectionId + ' | activeLang=' + (this.activeLang || '(primary)'),
                        '| isSchemaStale=' + isSchemaStale + ' (stored="' + storedSchema + '" vs current="' + VOICEOVER_SCHEMA_VERSION + '")',
                        '| isWordCountStale=' + isWordCountStale + ' (stored=' + storedWordCount + ' current=' + currentWordCount + ')',
                        '| isHashStale=' + isHashStale,
                        '| isLangPrefixMissing=' + isLangPrefixMissing,
                        '| hasNoHash=' + hasNoHash,
                        '| hasNoFingerprint=' + hasNoFingerprint,
                        '| → path=' + ((this.editMode || this.canEdit || this.isTeacher) ? 'TEACHER-REGEN (URL will be deleted!)' : 'STUDENT-PLAY-ANYWAY'));
                    ...
                    // the console.log correctly showed "TEACHER-REGEN", but was never added to THIS
                    ...
                    if (isLangPrefixMissing || this.editMode || ((this.canEdit || this.isTeacher) && (isSchemaStale || hasNoFingerprint || isWordCountStale || isHashStale))) {
                        // CC-ML-DEBUG v13.4
                        console.error('%c[CC-ML PLAY URL-DELETED]',
                            'background:#dc2626;color:#fff;padding:2px 6px;border-radius:3px;',
                            'section=' + sectionId + ' | activeLang=' + (this.activeLang || '(primary)'),
                            '| URL WAS:', section.voiceoverUrl,
                            '| Reason: ' + (isLangPrefixMissing ? 'lang-prefix-missing (all users) → on-demand TTS will fire' : 'teacher stale/no-fingerprint → on-demand TTS will fire'));
                        delete section.voiceoverUrl;
                        delete section.voiceoverSchemaVersion;
                        ...
                        console.warn('[VOICEOVER v' + CC_VERSION + '] Student mode - playing pre-gen audio as-is | schema: ' + storedSchema + ' | words: ' + storedWordCount + '/' + currentWordCount + ' | section: ' + sectionId);
                        // CC-ML-DEBUG v13.4
                        console.log('%c[CC-ML PLAY STUDENT-STALE-OK]',
                            'background:#16a34a;color:#fff;padding:2px 6px;border-radius:3px;',
                            'section=' + sectionId + ' | activeLang=' + (this.activeLang || '(primary)'),
                            '| Playing HTTPS URL directly (stale but student path):',
                            section.voiceoverUrl ? section.voiceoverUrl.slice(0,60)+'…' : '(none)');
                        this.playCachedVoiceover(section.voiceoverUrl, btn, sectionId, section, true);
                        return;
                    }
                } else {
                    // CC-ML-DEBUG v13.4: clean (non-stale) URL play
                    console.log('%c[CC-ML PLAY CLEAN-URL]',
                        'background:#16a34a;color:#fff;padding:2px 6px;border-radius:3px;',
                        'section=' + sectionId + ' | activeLang=' + (this.activeLang || '(primary)'),
                        '| Playing HTTPS URL (fingerprint OK):',
                        section.voiceoverUrl ? section.voiceoverUrl.slice(0,60)+'…' : '(none)');
                    this.playCachedVoiceover(section.voiceoverUrl, btn, sectionId, section, true);
                    return;
                }
            ...
            if (this.voiceoverWaitBypassed && this.voiceoverLoading[sectionId]) {
                console.warn('[VOICEOVER v' + CC_VERSION + '] BYPASSED+LOADING section ' + sectionId + '  -  user bypassed audio wait, skipping 230s loop');
                Notification.addNotification({
            ...
            if (this.voiceoverLoading[sectionId]) {
                console.warn('[VOICEOVER v' + CC_VERSION + '] WAITING for in-progress load of section ' + sectionId + ' (230s timeout)');
                ...
                var checkInterval = setInterval(function() {
                    ...
                    if (Date.now() - waitStartTime > 230000) {
                        ...
                        console.error('%c[VOICEOVER v' + CC_VERSION + '] TIMEOUT 230s section ' + sectionId + ' | cachedSections: ' + Object.keys(self.voiceoverCache).join(','), 'color: #ef4444; font-weight: bold');
                        Notification.addNotification({
            ...
            if (!this.editMode && !this.canEdit && !this.isTeacher && !_wasPregenerated) {
                console.warn('[VOICEOVER v' + CC_VERSION + '] STUDENT GUARD section ' + sectionId + '  -  on-demand blocked. Button disabled. manifest.voiceoversComplete=' + this.manifest.voiceoversComplete);
            ...
            if (_wasPregenerated && !this.editMode && !this.canEdit && !this.isTeacher) {
                console.log('[CC v' + CC_VERSION + '] STUDENT SENTINEL section ' + sectionId + '  -  pregenerated sentinel, fetching from PHP cache (0 credits)');
            }
            ...
            console.log('%c[CC-ML TTS-TEXT-SAMPLE v13.8]',
                'background:#be123c;color:#fff;padding:2px 6px;border-radius:3px;font-weight:bold;',
                'section=' + sectionId,
                '| activeLang=' + (this.activeLang || '(primary)'),
                '| textLength=' + text.length,
                '\n  text[0:250]:', text.substring(0, 250),
                '\n  ⚠ IF THE ABOVE TEXT IS ENGLISH and activeLang is non-English, content was generated in English by the AI — regenerate the course to get correct language content.');
            ...
            console.log('%c[CC-ML PLAY ON-DEMAND-TTS]',
                'background:#0369a1;color:#fff;padding:2px 6px;border-radius:3px;',
                'section=' + sectionId,
                '| activeLang=' + (this.activeLang || '(primary)'),
                '| language sent=' + (this.activeLang || this.voiceLanguage),
                '| voice sent=' + this.voiceName,
                '| voiceLanguage (primary)=' + this.voiceLanguage,
                '| _wasPregenerated=' + _wasPregenerated,
                '| editMode=' + this.editMode,
                '| ⚠ If language≠activeLang this is a bug');
            ...
            .then(function(response) {
                ...
                .then(function(data) {
                    ...
                    if (data.pending) {
                        delete self.voiceoverLoading[sectionId];
                        btn.removeClass('cc5-loading');
                        console.warn('[VOICEOVER v' + CC_VERSION + '] ON-DEMAND PENDING section ' + sectionId + ' | ' + _onDemandDur + 's  -  server busy (lock held by another process)');
                        Notification.addNotification({
                            message: 'Voiceover is still being generated in the background. Please try the play button again in a few minutes.',
                            type: 'info'
                        });
                    ...
                    if (data.success && data.audioContent) {                        var audioUrl = 'data:' + (data.audioType || 'audio/ogg') + ';base64,' + data.audioContent;
                        ...
                        console.error('[VOICEOVER v' + CC_VERSION + '] ON-DEMAND FAIL section ' + sectionId + ' | ' + _onDemandDur + 's | type: ' + errorType + ' | ' + errorMsg);
                ...
                .catch(function(error) {
                    ...
                    console.error('[VOICEOVER v' + CC_VERSION + '] ON-DEMAND ' + (isOdAborted ? 'TIMEOUT 200s' : 'NETWORK ERR') + ' section ' + sectionId + ' | ' + _onDemandNetDur + 's | ' + errorMsg);
                    Notification.addNotification({
                        message: isOdAborted
        ...
        playCachedVoiceover: function(audioDataUrl, btn, sectionId, section, isPreGenerated) {
            ...
            this.currentAudio.onerror = function(e) {
                ...
                console.error('[CC v' + CC_VERSION + '] Audio playback error - code: ' + errorCode + ', message: ' + errorMsg + ', sectionId: ' + sectionId);
                if (isPreGenerated) {
                    Notification.addNotification({
            ...
            if (_playPromise !== undefined) {
                _playPromise.catch(function(e) {
                    console.error('[CC v' + CC_VERSION + '] audio.play() rejected | sectionId=' + sectionId + ' | ' + e.name + ': ' + e.message);
        ...
        showDocumentModal: function(docId, docName) {
            ...
            if (pregenerated && pregenerated.content) {
                // If pregenerated has no unitCode, it's an old document - regenerate it
                if (!pregenerated.unitCode) {
                    contextMatches = false;
                    pregenerated = null;
                } else if (pregenerated.unitCode !== currentUnit) {
                    contextMatches = false;
                    pregenerated = null;
                }
            }
    ...
    return {
        ...
        init: function(config) {            $(document).ready(function() {
                ...
                Ajax.call([{
                    ...
                    container.html('<div class="cc5-error"><div class="cc5-error-icon">' + getIcon('alertTriangle') + '</div><h3>Unable to Load Content</h3><p>We encountered a problem loading this activity. Please try refreshing the page.</p><button type="button" class="cc5-btn cc5-retry-btn" onclick="location.reload()">Refresh Page</button></div>');
                });
            });
        }
    };
